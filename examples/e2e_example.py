...
- Calculate KPIs
- Save procurement, inventory, and demand/supply plots to the output folder
...
# --- 8-10. Visualize and Save Results ---
plot_files = {}
if linear_solution:
    print("Saving plots for Linear Solution...")
    ...
    plot_procurement_plan(
        ...
        'Linear Solution: Procurement Plan'
    )
    plot_inventory_levels(
    ...
    plot_demand_vs_supply(
        ...
        'Linear Solution: Demand vs. Supply'
    )
...
if heuristic_solution:
    print("Saving plots for Heuristic Solution...")
    ...
    plot_procurement_plan(
        ...
        'Heuristic Solution: Procurement Plan'
    )
    plot_inventory_levels(
    ...
    plot_demand_vs_supply(
        ...
        'Heuristic Solution: Demand vs. Supply'
    )
...
if nonlinear_solution:
    print("Saving plots for Nonlinear Solution...")
    ...
    plot_procurement_plan(
        ...
        'Nonlinear Solution: Procurement Plan'
    )
    plot_inventory_levels(
    ...
    plot_demand_vs_supply(
        ...
        'Nonlinear Solution: Demand vs. Supply'
    )
...
print("\nAll plots and the HTML report are saved in the 'output' folder. E2E process complete!\n") 